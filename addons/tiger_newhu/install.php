<?php
$installSql = <<<sql
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_ad` (
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_appbottomdh` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
`px` int(10) DEFAULT '0',
...
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
`appid` varchar(200) COMMENT 'APP的APPID',
`mchid` varchar(200) COMMENT '商户号',
`jiamistr` varchar(200) COMMENT '加密字符',
...
`lbygz` varchar(100) COMMENT '自定义预估赚名称',
`lbsjz` varchar(100) COMMENT '自定义升级赚名称',
`tptype` int(5) DEFAULT '0' COMMENT '列表模版',
PRIMARY KEY (`id`),
KEY `weid` (`weid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_cdtype` (
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_ck` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
`data` text,
`taodata` text,
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_dborder` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
`starttimestamp` int(10) COMMENT '下单时间',
`endtimestamp` int(10) COMMENT '成功时间',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_dbrecord` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_dianyuan` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_gfhuodong` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
`weid` int(10) unsigned NOT NULL,
`px` int(10) NOT NULL DEFAULT '0',
`title` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_goods` (
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_hexiao` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_jdorder` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_jdtjorder` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
...
`uid` varchar(20) COMMENT '用户UID share表',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_jdyfgorder` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
`weid` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_mdorder` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
`openid` varchar(255) DEFAULT '0',
`nickname` varchar(255) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_member` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_miandangoods` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
`itemtitle` varchar(300),
`shoptype` int(10) DEFAULT '0',
`itemid` varchar(200),
`itemprice` varchar(200),
`itemendprice` varchar(200),
`couponmoney` varchar(200),
`itemsale` varchar(200),
`rate` varchar(50) COMMENT '佣金比例',
`url` varchar(500),
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_miandanset` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
`mdtype` int(3) DEFAULT '0' COMMENT '免单开关1 开',
`mdrensum` int(3) DEFAULT '0' COMMENT '免单几天内,算新用户',
`starttime` varchar(200) COMMENT '开始时间',
`endtime` varchar(200) COMMENT '结束时间',
`miandanpid` varchar(200) COMMENT '名单指定PID',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_mobanmsg` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
`title` varchar(250) COMMENT '模版标题',
`mbid` varchar(250) COMMENT '模版ID',
`first` varchar(250) COMMENT '头部内容',
`firstcolor` varchar(100) COMMENT '头部颜色',
`zjvalue` text COMMENT '中间内容',
`zjcolor` text COMMENT '中间颜色',
`remark` varchar(250) COMMENT '尾部内容',
`remarkcolor` varchar(100) COMMENT '尾部颜色',
`turl` varchar(250) COMMENT '模版链接',
`createtime` int(10) NOT NULL,
PRIMARY KEY (`id`),
KEY `weid` (`weid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_msg` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
`weid` int(10) unsigned NOT NULL,
`title` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_newtbgoods` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
`createtime` int(10) NOT NULL,
`quan_id` varchar(100) COMMENT '优惠券ID',
`tj` int(11) COMMENT '1 秒杀 2 叮咚抢 ',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_order` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
`openid` varchar(255) DEFAULT '0',
`nickname` varchar(255) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_paylog` (
`id` int(11) unsigned NOT NULL AUTO_INCREMENT,
`uniacid` int(11),
`dwnick` varchar(255) COMMENT '微信用户昵称',
`dopenid` varchar(255) COMMENT '微信用户openid',
`dtime` int(11) COMMENT '打款时间',
`dcredit` int(11) COMMENT '消耗积分',
`dtotal_amount` int(11) COMMENT '金额，分为单位',
`dmch_billno` varchar(50) COMMENT '生成的商户订单号',
`dissuccess` tinyint(1) COMMENT '是否打款成功',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_poster` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11),
`title` varchar(100),
`type` int(1),
`data` text,
`createtime` varchar(12),
`bg` varchar(200),
`tzurl` varchar(250),
`city` varchar(200),
`doneurl` varchar(200),
...
`sharegzurl` varchar(200),
`sharedesc` varchar(200),
`sharethumb` varchar(200),
`stitle` text,
`sthumb` text,
`sdesc` text,
`surl` text,
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_record` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11),
`pid` int(11),
`openid` varchar(200),
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_request` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
`weid` int(10) unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_sdorder` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
`weid` int(10) unsigned NOT NULL,
`nickname` varchar(100) NOT NULL,
`from_user` varchar(50) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_set` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
`hbsum` int(1) COMMENT '红包总金额',
`hbtext` varchar(200) COMMENT '红包兑换结束提示',
PRIMARY KEY (`id`),
KEY `idx_weid` (`weid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_share` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
`openid` varchar(50) DEFAULT '0',
`tel` varchar(15),
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_shoucang` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_tbgoods` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
`weid` int(10) unsigned NOT NULL,
`px` int(10) NOT NULL DEFAULT '0',
`zy` int(10) NOT NULL DEFAULT '0' COMMENT '1 大淘客  2互力 3鹊桥库',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_tbgoodsqf` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
`weid` int(10) unsigned NOT NULL,
`qf` int(10) NOT NULL DEFAULT '0' COMMENT '0不群发  1群发库',
`lxtype` int(2) NOT NULL DEFAULT '0' COMMENT '佣金类别0普通  1定向  2鹊桥 用这个',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_ticket` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_tixianlog` (
`id` int(11) unsigned NOT NULL AUTO_INCREMENT,
`uniacid` int(11),
`dwnick` varchar(255) COMMENT '微信用户昵称',
`dopenid` varchar(255) COMMENT '微信用户openid',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_tkorder` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_tksign` (
`id` int(11) NOT NULL AUTO_INCREMENT,
`weid` int(11) DEFAULT '0',
`tbuid` varchar(50),
`sign` varchar(100),
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_txlog` (
`id` int(11) unsigned NOT NULL AUTO_INCREMENT,
`weid` int(11),
`uid` varchar(255) COMMENT '用户UID share表',
...
CREATE TABLE IF NOT EXISTS `ims_tiger_newhu_zttype` (
`id` int(10) unsigned NOT NULL AUTO_INCREMENT,
`weid` int(10) unsigned NOT NULL,
`px` int(10) NOT NULL DEFAULT '0',
`title` varchar(50) NOT NULL,
