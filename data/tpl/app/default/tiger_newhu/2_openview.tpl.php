...
<link rel="stylesheet" type="text/css" href="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style1/css/style.css?t=4" />
...
<div class="safari_top">
    ...
    <div class="safari_img am-text-right" onclick="hidetip()">
        ...
        <img id="go_tip" src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style1/css/jump_coupon_android.png" alt="" />
...
<script>
    ...
    $(function(){
        ...
        if (ua.match(/iphone/i) == "iphone" || ua.match(/ipad/i) == "ipad") {
            ...
            $("#go_tip").attr("src", "<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style1/css/jump_coupon_ios.png");

        } else {

            $(".safari_top").css("display", "block");

            $("#go_tip").attr("src", "<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style1/css/jump_coupon_android.png");
...
<script>
   ...
   $(document).ready(function(e){
        ...
        function openApp(url) {
						...
						var qd="<?php  echo $qd;?>";//http://oauth
						if(qd==1){
							var tb_url = url.replace("http://oauth", "oauth");
						}else{
     ...
     //函数执行
       ...
       $("body").html("<center style=\"margin-top: 10px;\">唤醒手机淘宝中...</center>");
            ...
            if (ua.match(/iphone os 9/i) == "iphone os 9") {
                ...
                openIphoneApp_ios_9("<?php  echo $url;?>");

            } else {

                openApp("<?php  echo $url;?>");
