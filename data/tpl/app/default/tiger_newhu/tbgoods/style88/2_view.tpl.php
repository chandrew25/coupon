...
<head>
    ...
    <title><?php  if($share['nickname']) { ?><?php  echo $share['nickname'];?>的<?php  if($bl['fzname']) { ?><?php  echo $bl['fzname'];?><?php  } else { ?>分站<?php  } ?><?php  } ?><?php  echo $views['itemtitle'];?></title>
    ...
    <script src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/js/lib.js"></script>
     <script src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/js/jquery.qrcode.min.js"></script>
    ...
    <div class="main">
        ...
        <div class="g-return">
            <a  href="javascript:void(0);" onclick="history.go(-1);">
                <img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/images/zys_img19.png" alt="" />
            </a>
        </div>
        <div class="g-btn">
            <a href="<?php  echo $this->createMobileUrl('index',array('pid'=>$pid,'dluid'=>$dluid))?>">
                <img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/images/ico-g1-1.png" alt="" />
            </a>
            <div class="myfancy"  id="open_fullimg_btn">
                <img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/images/ico-g1-2.png" alt="" />
            </div>
			<?php  if($cfg['viewtk']!=1) { ?>
            <a class="a1" href="<?php  echo $this->createMobileUrl('cqlist',array('pid'=>$pid,'dluid'=>$dluid,'key'=>$views['itemtitle']))?>">
                <img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/images/ico-g1-3.png" alt="" />
            </a>
			<?php  } ?>
        </div>
        <div class="box-list">
            <ul class="ul-tab-g1 TAB_CLICK2" id=".tab-con1">
                <?php  if($views['videoid']!=0) { ?><li><a href="javascript:;"><i></i>视频</a></li>
                <li class="on"><a href="javascript:;">图片</a></li>
				<?php  } ?>
            </ul>
			<?php  if($views['videoid']!=0) { ?>
            <div class="tab-con1">
                <div class="m-video">
                    <div class="con">
                        <video x-webkit-airplay="true" playsinline webkit-playsinline="false" x5-video-player-type="h5" src="http://cloud.video.taobao.com/play/u/1/p/1/e/6/t/1/<?php  echo $views['videoid'];?>.mp4" controls></video>
                    </div>
                </div>
            </div>
			<?php  } ?>
            <div class="tab-con1 ok">
                ...
                <div class="slider-pic1">
                    <div class="swiper-wrapper">
                    	<?php  if($tbview['small_images']['string']) { ?>
						<?php  if(is_array($tbview['small_images']['string'])) { foreach($tbview['small_images']['string'] as $v) { ?>
						...
						<div class="swiper-slide">
                            <a href="">
                                <div class="pic">
                                    <img src="<?php  echo $views['itempic'];?>" alt="" />
                                </div>
                            </a>
                        </div> 
						<?php  } ?>
        ...
        <div class="m-price1">
            ...
            <div class="num">
                <span class="sp1"><em>¥</em><?php  echo $views['itemendprice'];?></span>
                <div class="con">
                    <span class="sp2"><em>¥</em><?php  if($views['itemprice']<>'0.00') { ?><?php  echo $views['itemprice'];?><?php  } else { ?><?php  echo $views['itemendprice']+$views['couponmoney']?><?php  } ?></span>
                    <div class="sp3">
                        <span><em><?php  echo $views['itemsale'];?></em>件已售</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="m-info1 louti" id="louti1">
            <div class="tit">
                <a href="javascript:;" class="heart"><i <?php  if($scview['title']) { ?>class="on"<?php  } ?>></i>收藏</a>
                <h3>
                    <div class="icon">
						<?php  if($views['shoptype']=='B') { ?>
                        <img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/images/tm.png" alt="" />
						<?php  } else { ?>
						<img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/images/tb.png" alt="" />
						<?php  } ?>
					</div>
                    <?php  echo $views['itemtitle'];?>
                </h3>
            </div>
            <!--<div class="t1">
            ...
            <?php  if($flyj<>'0.00') { ?><?php  if($cfg['rxyjxs']==1) { ?><?php  if($flyj) { ?>
            <div class="t2" style="font-size: 14px;">
                <!--<div class="num"><span>33</span>人已抢</div>-->
                <div class="price">
                    <span class="sp1">奖</span>
                    <span class="sp2"><!--<i>¥</i>--><em><?php  if($dlyj) { ?><?php  echo $flyj;?><?php  } else { ?><?php  echo $flyj;?><?php  echo $lx;?><?php  } ?></em></span>
                    <!--<span class="sp3">原价<em>¥129</em></span>-->
                </div>
            </div>
            <?php  } ?><?php  } ?><?php  } ?>
        </div>
		<?php  if($views['couponmoney']) { ?>
			<?php  if($views['couponendtime']) { ?>
			<div class="m-coupon1">
				<a href="javascript:;" class="js-pop">
					<span class="sp1">立即领券</span>
					<div class="con">
						<span class="sp2" style="width:60px;"><i>¥</i><em><?php  echo intval($views['couponmoney'])?></em></span>
						<div class="inner">
							<h3>优惠券有效期至:</h3>
							<p><?php  echo date('Y-m-d H:i:s',$views['couponendtime'])?></p>
						</div>
					</div>
				</a>
			</div>
			<?php  } ?>
		<?php  } ?>
		<?php  if($views['itemdesc']) { ?>
        <div class="m-txt1">
            <h3>推荐理由:</h3>
            <p><span id="p-text"><?php  echo $views['itemdesc'];?></span> <a href="javascript:;" class="btn copy-p" data-clipboard-action="copy" data-clipboard-target="#p-text">复制</a></p>
        </div>
		<?php  } ?>
        <!-- <div class="m-txt2">
            <a href="">
                <div class="top">
                    <span class="btn">店铺所有优惠</span>
                    <div class="imgtxt">
                        <div class="pic">
                            <img src="<?php  echo $shop['shop_url'];?>" alt="" />
                        </div>
                        <div class="txt">
                            <h3><?php  echo $tbview['nick'];?></h3>
                            <div class="icon">
                                <img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/images/ico-g8.png" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="bd">
                    <div class="item">
                        <h3>宝贝描述:4.8</h3>
                        <div class="icon">
                            <img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/images/ico-g9-1.png" alt="" />
                        </div>
                    </div>
                    <div class="item">
                        <h3>宝贝描述:4.8</h3>
                        <div class="icon">
                            <img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/images/ico-g9-2.png" alt="" />
                        </div>
                    </div>
                    <div class="item">
                        <h3>宝贝描述:4.8</h3>
                ...
                <ul class="ul-imgtxt1">
                    <li>
                        <div class="con">
                            <a href="">
                                <div class="pic">
                                    <img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/images/g-pic4.jpg" alt="" />
                                </div>
                                <div class="txt">
                                    <h3>【珀莱雅官方官方官方】</h3>
                                    <span class="sp1">10元券</span>
                                    <span class="sp2">券后价<em>¥75</em></span>
                                </div>
                            </a>
                        </div>
                    </li>
		...
		<script>
			var itemid="<?php  echo $views['itemid'];?>"; 
// 			$.ajax({
...
var url="https://h5api.m.taobao.com/h5/mtop.taobao.detail.getdesc/6.0/?jsv=2.4.0&appKey=12574478&t=1560248888574&sign=2db06c3e2c1ec60d2cb53e4f06e92077&api=mtop.taobao.detail.getdesc&v=6.0&AntiFlool=true&AntiCreep=true&type=jsonp&dataType=jsonp&callback=mtopjsonp1&data=%7b%22id%22%3a%22"+itemid+"%22%2c%22type%22%3a%221%22%7d";
console.log(url)
					$.ajax({
                        url: url,
                        dataType: 'jsonp',
                        ...
                        success: function (dat) {	
						   ...
						   if (dat.ret[0] == "SUCCESS::调用成功") {
                              ...
                              while( (temp= patt.exec(picinfo)) != null ) {
								  if(temp[1].indexOf("spaceball.gif")>0){
								  }else{
        ...
        <ul class="ul-listy3">
			<?php  if(is_array($viewslist)) { foreach($viewslist as $v) { ?>
            <li>
                <div class="con">
                    <div class="pic">
                        <a href="<?php  echo $this->createMobileUrl('view',array('itemid'=>$v['itemid'],'lm'=>$cfg['mmtype'],'pid'=>$pid))?>"><img src="<?php  echo $v['itempic'];?>" alt=""></a>
                    </div>
                    <div class="txt">
                        <h5><a href="<?php  echo $this->createMobileUrl('view',array('itemid'=>$v['itemid'],'lm'=>$cfg['mmtype'],'pid'=>$pid))?>"><?php  echo $v['itemtitle'];?></a></h5>
                        <div class="sp-con">
                            <span class="l">原价 ¥<?php  echo $v['itemprice'];?></span><span class="r">已售<?php  echo $v['itemsale'];?>件</span>
                        </div>
                        <div class="price">
                            <div class="quan">
                                <em><?php  echo $v['couponmoney'];?>元券</em>
                            </div>
                            券后价 <span><i>¥</i><?php  echo $v['itemendprice'];?></span>
                        </div>
                    </div>
                </div>
            </li>
    ...
    <div class="m-pop2" id="win2">
        ...
        <div class="con">
            <div class="m-pic1">
                ...
                <div class="a-grop">
                    <a href="javascript:;" class="a-1 copy" data-clipboard-action="copy" data-clipboard-target="#js-text2">复制文案</a><!-- <a href="javascript:;" class="a-2">说明</a> -->
                </div>
            </div>
        </div>
    </div>
	<script>
		//商品海报
				...
				$("#open_fullimg_btn").click(function(){//商品二维码	
					...
					$.ajax({
			            url:"<?php  echo $this->createMobileUrl('getewm')?>",
			              type:'post',
			              data:{
			              	url:encodeURIComponent("<?php  echo $ewmurl;?>"),
			              },
			            dataType:"json", 
			            success: function (data) {
				...
				function canvasApp(code_img_src) {	
		            ...
		            bj_img.onload = function(){
		                ...
		                item_img.src = "<?php  echo $views['itempic'];?>";
		...
		//	
							...
							/*图标*/
							var shoptype="<?php  echo $views['shoptype'];?>";
		...
		//	
						    ...
						    ctx.drawImage(tb_img, canvas.width -620,canvas.width +28,35, 35);
								...
								/*商品标题*/
								var str = "                 <?php  echo $views['itemtitle'];?>";
								...
								/*现价*/
								 var price = "¥ <?php  echo $views['itemprice'];?>";
								ctx.fillStyle = '#aba0ac';
								ctx.textAlign = 'left';
								...
								/*在售价格*/
								var end_price = "¥ <?php  echo $views['itemendprice'];?>";
								...
								ctx.fillText(end_price,190,initHeight + 75);
								 ...
								 /*秘券金额*/
								 var coupaa="<?php  echo $views['couponmoney'];?>";
								  var couponmoney = "<?php  echo $views['couponmoney'];?>元";
								  if(coupaa=="null"){
									  couponmoney="0元";
								  }
								  //alert(couponmoney);
								  ...
								  ctx.font = '20px Helvetica';
								  ctx.textBaseline = "top";
								  ctx.fillText(couponmoney,55,initHeight + 87);
	...
	<?php  if($cfg['lbtx']==1) { ?>
    <!-- 弹窗 end -->
    <div class="swiper-pop" style="display: none;">
        <div class="swiper-wrapper">
			<?php  if(is_array($msg1)) { foreach($msg1 as $v) { ?>
    ...
    <div class="footer">
        <div class="div-a">
            <a href="<?php  echo $this->createMobileUrl('index',array('pid'=>$pid,'dluid'=>$dluid))?>"><em class="ico" style="background-image: url(<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/images/yi1.png)"></em><span>首页</span></a>
        </div>
        <div class="div-a">
            <a href="javascript:;" class="js-collect <?php  if($scview['title']) { ?>on<?php  } ?>"><em class="ico" style="background-image: url(<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/images/star.png)"></em><span>收藏</span></a>
        </div>
        <div class="btn">
        	   <?php  if($_GPC['gopturl']) { ?>
				  <a href="<?php  echo $this->createMobileUrl('openview',array('dluid'=>$dluid))?>&link=<?php  echo $rhyurl;?>" class="a1">浏览器打开</a>
                  <a href="javascript:;" class="js-pop a2">去拼团</a>
				<?php  } else { ?>
				  <a href="<?php  echo $this->createMobileUrl('openview',array('dluid'=>$dluid))?>&link=<?php  echo $rhyurl;?>" class="a1">浏览器打开</a>
                  <a href="javascript:;" class="js-pop a2">淘口令领券</a>
				<?php  } ?>            
        </div>
    </div>
    <div class="m-pop">
        ...
        <div class="inner">
            <div class="con">
                ...
                <div class="pic"><img src="<?php  echo $views['itempic'];?>" alt=""></div>
                <div class="txt" id="js-text"><?php  echo $msg;?></div>
                <a href="javascript:;" class="copy-p1 copy" data-clipboard-action="copy" data-clipboard-target="#js-text">一键复制</a>
            </div>
        </div>
    </div>
    <script src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/js/swiper.min.js"></script>
    <script src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/style88/js/jquery.lwtcountdown-1.0.js"></script>
		...
		.closebtn img{width: 35px;height:35px;}
			...
			<div class='mbboxa' id="closkl" style="display: none;">
				<div class='tcbox'>
					...
					<div class='tcxbox'>
								<div class='tcbt'>一键复制->全选->打开淘$$寶APP授权</div>
			...
			<script>
		    	...
		    	var shareqdid="<?php  echo $zxshare['qdid'];?>";		    	
		    	if(qdtype==1){
		    		if(shareqdid==0){
    ...
    <script type="text/javascript">
        ...
        $('#countdown').countDown({
            targetDate: {
                'day':"<?php  echo $views['day'];?>",
                'month':"<?php  echo $views['month'];?>",
                'year': "<?php  echo $views['year'];?>",
                'hour': 0,
                'min': 0,
                'sec': 0
            }
        ...
        // 复制文字
        var clipboard = new Clipboard('.a-1');
        clipboard.on('success', function(e) {
            layer.open({
			    content: '复制成功'
			    ,skin: 'msg'
        ...
        var clipboard = new Clipboard('.copy-p1');
        clipboard.on('success', function(e) {
            layer.open({
			    content: '复制成功'
			    ,skin: 'msg'
        ...
        var clipboard = new Clipboard('.copy-p');
        clipboard.on('success', function(e) {
            layer.open({
			    content: '复制成功'
			    ,skin: 'msg'
        ...
        $('.copy-p1').on('click', function() {
            $(this).addClass('on');
            $(this).html('复制成功');
        })
        $('.heart,.js-collect').on('click', function() {
        	var shareuid="<?php  echo $zxshare['from_user'];?>";
        	if(!shareuid){
        		layer.open({
				    content: '请先登录！'
				    ,skin: 'msg'
            ...
            if ($(".m-info1 i,.js-collect").hasClass('on')) {
            	$.ajax({
					url:"<?php  echo $this->createMobileUrl('shoucang')?>",
						type:'post',
						data:{
							itemid:"<?php  echo $views['itemid'];?>",
							title:"<?php  echo $views['itemtitle'];?>",
							pic_url:"<?php  echo $views['itempic'];?>",
							openid:"<?php  echo $zxshare['from_user'];?>",
							itemendprice:"<?php  echo $views['itemendprice'];?>",
							itemprice:"<?php  echo $views['itemprice'];?>",
							itemsale:"<?php  echo $views['itemsale'];?>",
							couponmoney:"<?php  echo $views['couponmoney'];?>",
							tkl:"<?php  echo $views['taokouling'];?>",
							rate:"<?php  echo $views['yongjin'];?>",
							uid:"<?php  echo $zxshare['id'];?>",
						},
					dataType:"json", 
					success: function (data) {
						console.log(data);
						if(data.error==1){
							...
							$(".m-info1 i").removeClass('on');
			                $(".js-collect").removeClass('on');
			                layer.open({
							    content: '取消收藏'
							    ,skin: 'msg'
							    ,time: 1 //2秒后自动关闭
            	...
            	$.ajax({
					...
					success: function (data) {
						...
						if(data.error==1){
			                ...
			                $(".m-info1 i,.js-collect").addClass('on');
						}
					}
				});
    ...
    <a class="gotop iconfont icon-shang" href="javascript:;"></a>
		...
		<script>
			...
			var desc="<?php  echo $views['itemdesc'];?>";
			var imgUrl="<?php  echo $views['itempic'];?>";
