...
<head>
    ...
    <title>好货高佣榜</title>
    <meta name="description" content="好货高佣榜" />
    <meta name="keywords" content="好货高佣榜" />
...
<body>
    ...
    <div class="slot-ban" id="top">
        <a href=""><img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/qtz/images/hhgyb.jpg" alt=""></a>
    </div>

    <div class="slot-tabs">
        <div class="header-nav">
            <ul class="header-nav-list">
                <li class="item active js-nav-item"><a href="javascript:;"   onclick="classtype(8209);"><span>精选</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;"  onclick="classtype(8267);"><span>女装</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(8326);"><span>家居家装</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(8268);"><span>数码家电</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(8335);"><span>母婴</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(8337);"><span>食品</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(8328);" "><span>男装</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(8330);"><span>美妆个护</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(8334);"><span>运动户外</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(8332);"><span>内衣</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(8338);"><span>鞋包配饰</span></a></li>
            </ul>
    ...
    <a href="#top" class="to-top" style="bottom: 100px;width: 60px;height: 60px;right: 15px;"></a>
							...
							layui.use('flow', function(){
								...
								flow.load({
									...
									,done: function(page, next){
										...
										console.log(page);
										console.log("<?php  echo $this->createMobileUrl('hhgyb1111',array('tj'=>$tj,'key'=>$key,'tm'=>$tm,'typeid'=>$typeid,'pid'=>$pid,'zn'=>$zn,'lx'=>$lx,))?>&page="+page+"&MaterialId="+MaterialId);
										var tmpl='';
															
										$.get("<?php  echo $this->createMobileUrl('hhgyb1111',array('tj'=>$tj,'key'=>$key,'tm'=>$tm,'typeid'=>$typeid,'pid'=>$pid,'zn'=>$zn,'lx'=>$lx))?>&page="+page+"&MaterialId="+MaterialId, function(res){
										// alert(res); 
										res=JSON.parse(res);
											...
											layui.each(res.data, function(index, item){
												...
												tmpl+='<a class="item" href="<?php  echo $this->createMobileUrl("view")?>'+'&id='+item.id+'&dluid=<?php  echo $dluid;?>&lm='+item.lm+'&itemid='+item.itemid+'&org_price='+item.itemprice+'&price='+item.itemendprice+'&coupons_price='+item.couponmoney+'&goods_sale='+item.itemsale+'&title='+item.itemtitle+'&pic_url='+encodeURIComponent(item.itempic)+'&pid='+item.pid+'">';
													...
													tmpl+='<div class="txt">';
														tmpl+='<div class="name">'+item.shoptype+item.itemtitle+'</div>';
														tmpl+='<div class="info">';
