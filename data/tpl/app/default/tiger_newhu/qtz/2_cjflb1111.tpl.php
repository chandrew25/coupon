...
<head>
    ...
    <title>天猫超级福利榜</title>
    <meta name="description" content="天猫超级福利榜" />
    <meta name="keywords" content="天猫超级福利榜" />
...
<body>
    ...
    <div class="slot-ban" id="top">
        <a href=""><img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/qtz/images/cjflb.png" alt=""></a>
    </div>

    <div class="slot-tabs">
        <div class="header-nav">
            <ul class="header-nav-list">
                <li class="item active js-nav-item" style="width: 25%;"><a href="javascript:;"   onclick="classtype(9938);"><span>母婴百货</span></a></li>
                <li class="item js-nav-item" style="width: 25%;"><a href="javascript:;"  onclick="classtype(9940);"><span>美食特产</span></a></li>
                <li class="item js-nav-item" style="width: 25%;"><a href="javascript:;" onclick="classtype(9937);"><span>美妆个护</span></a></li>
                <li class="item js-nav-item" style="width: 25%;"><a href="javascript:;" onclick="classtype(9936);"><span>服饰鞋包</span></a></li>              
            </ul>
        </div>
    </div>
							...
							layui.use('flow', function(){
								...
								flow.load({
									...
									,done: function(page, next){
										...
										console.log(page);
										console.log("<?php  echo $this->createMobileUrl('sstop1111',array('tj'=>$tj,'key'=>$key,'tm'=>$tm,'typeid'=>$typeid,'pid'=>$pid,'zn'=>$zn,'lx'=>$lx,))?>&page="+page+"&MaterialId="+MaterialId);
										var tmpl='';
															
										$.get("<?php  echo $this->createMobileUrl('sstop1111',array('tj'=>$tj,'key'=>$key,'tm'=>$tm,'typeid'=>$typeid,'pid'=>$pid,'zn'=>$zn,'lx'=>$lx))?>&page="+page+"&MaterialId="+MaterialId, function(res){
										// alert(res); 
										res=JSON.parse(res);
