...
<head>
    ...
    <title>实时热销榜</title>
    <meta name="description" content="实时热销榜" />
    <meta name="keywords" content="实时热销榜" />
...
<body>
    ...
    <div class="slot-ban" id="top">
        <a href=""><img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/qtz/images/sshottop.jpg" alt=""></a>
    </div>
							...
							layui.use('flow', function(){
								...
								flow.load({
									...
									,done: function(page, next){
										...
										console.log(page);
										console.log("<?php  echo $this->createMobileUrl('sshottop1111',array('tj'=>$tj,'key'=>$key,'tm'=>$tm,'typeid'=>$typeid,'pid'=>$pid,'zn'=>$zn,'lx'=>$lx,))?>&page="+page+"&MaterialId="+MaterialId);
										var tmpl='';
															
										$.get("<?php  echo $this->createMobileUrl('sshottop1111',array('tj'=>$tj,'key'=>$key,'tm'=>$tm,'typeid'=>$typeid,'pid'=>$pid,'zn'=>$zn,'lx'=>$lx))?>&page="+page+"&MaterialId="+MaterialId, function(res){
										// alert(res); 
										res=JSON.parse(res);
