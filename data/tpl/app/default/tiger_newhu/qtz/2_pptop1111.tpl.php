...
<head>
    ...
    <title>TOP品牌尖货榜</title>
    <meta name="description" content="TOP品牌尖货榜" />
    <meta name="keywords" content="TOP品牌尖货榜" />
...
<body>
    ...
    <div class="slot-ban" id="top">
        <a href=""><img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/qtz/images/toppp.jpg" alt=""></a>
    </div>

    <div class="slot-tabs">
        <div class="header-nav">
            <ul class="header-nav-list">
                <li class="item active js-nav-item"><a href="javascript:;"   onclick="classtype(8286);"><span>精选</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;"  onclick="classtype(7843);"><span>女装</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(7849);"><span>家居家装</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(7851);"><span>数码家电</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(7852);"><span>母婴</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(7853);"><span>食品</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(7856);"><span>男装</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(7855);"><span>美妆个护</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(7858);"><span>运动户外</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(7857);"><span>内衣</span></a></li>
                <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(7854);"><span>鞋包配饰</span></a></li>
            </ul>
            <div class="filter-icon js_nav"></div>
        </div>
    </div>
    <ul class="header-nav-cont">
        <li class="item active js-nav-item"><a href="javascript:;"   onclick="classtype(7792);"><span>精选</span></a></li>
        <li class="item js-nav-item"><a href="javascript:;"  onclick="classtype(7843);"><span>女装</span></a></li>
        <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(7849);"><span>家居家装</span></a></li>
        <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(7851);"><span>数码家电</span></a></li>
        <li class="item js-nav-item"><a href="javascript:;" onclick="classtype(7852);"><span>母婴</span></a></li>
							...
							layui.use('flow', function(){
								...
								flow.load({
									...
									,done: function(page, next){
										...
										console.log(page);
										console.log("<?php  echo $this->createMobileUrl('pptop1111',array('tj'=>$tj,'key'=>$key,'tm'=>$tm,'typeid'=>$typeid,'pid'=>$pid,'zn'=>$zn,'lx'=>$lx,))?>&page="+page+"&MaterialId="+MaterialId);
										var tmpl='';
															
										$.get("<?php  echo $this->createMobileUrl('pptop1111',array('tj'=>$tj,'key'=>$key,'tm'=>$tm,'typeid'=>$typeid,'pid'=>$pid,'zn'=>$zn,'lx'=>$lx))?>&page="+page+"&MaterialId="+MaterialId, function(res){
										// alert(res); 
										res=JSON.parse(res);
