...
<body class="white">
    <div class="m-login">
        <form>
            <a href="javascript:void(0)" class="close" style="background-image: url(<?php  echo $_W['siteroot'];?>addons/tiger_wxdaili/template/mobile/public/images/return.png);"  onClick="javascript:history.back()"></a>
            <!-- <a href="" class="old"></a> -->
