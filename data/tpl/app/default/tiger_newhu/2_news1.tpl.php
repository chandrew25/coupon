...
<html>
	<head>
		<meta charset="utf-8">
		<title><?php  if($type==1) { ?>公告<?php  } else if($type==2) { ?>帮助中心<?php  } else if($type==3) { ?>新手攻略<?php  } ?></title>
		<meta name="viewport" content="width=device-width, initial-scale=1,maximum-scale=1,user-scalable=no">
		<meta name="apple-mobile-web-app-capable" content="yes">
		<meta name="apple-mobile-web-app-status-bar-style" content="black">

		<!--标准mui.css-->
		<link href="https://cdn.bootcss.com/mui/2.9.0/css/mui.min.css" rel="stylesheet">
		<script src="https://cdn.bootcss.com/mui/2.9.0/js/mui.min.js"></script>
	<!-- <link href="//img.cdn.aliyun.dcloud.net.cn/mui/dist/css/mui.min.css" rel="stylesheet" />
	<script src="//img.cdn.aliyun.dcloud.net.cn/mui/dist/js/mui.min.js"></script> -->
		<!--App自定义的css-->
		<style>
	...
	<body>
		...
		<header class="mui-bar mui-bar-nav">
			<a class="mui-action-back mui-icon mui-icon-left-nav mui-pull-left" href="javascript:void(0);" onclick="history.go(-1);"></a>
			<a id="menu" class="mui-action-menu mui-icon mui-icon-bars mui-pull-right" href="#topPopover"></a>
			<h1 class="mui-title"><?php  if($type==1) { ?>公告<?php  } else if($type==2) { ?>帮助中心<?php  } else if($type==3) { ?>新手攻略<?php  } ?></h1>
		</header>
		...
		<div class="mui-content" id="table">
			<!--<div id="box" class="mui-row" class="tab4" style="font-size:14px">
				<a href="<?php  echo $this->createMobileUrl('news',array('type'=>1))?>" class="mui-col-xs-3" <?php  if($type==1) { ?>id="mui-col-xs-3-active"<?php  } ?> style="text-align: center;width: 50%;">
					最新公告
				</a>
				<a href="<?php  echo $this->createMobileUrl('news',array('type'=>2))?>" class="mui-col-xs-3" <?php  if($type==2) { ?>id="mui-col-xs-3-active"<?php  } ?> style="text-align: center;width: 50%;">
					帮助中心
				</a>
			</div>-->
		        ...
		        layui.use('flow', function(){
		            ...
		            flow.load({
		                ...
		                ,done: function(page, next){
		                    var lis =[];
                            var tmpl='';
		                    $.get("<?php  echo $this->createMobileUrl('news1',array('type'=>$type,'pttype'=>$pttype))?>&page="+page, function(res){
		                    	res=JSON.parse(res);
