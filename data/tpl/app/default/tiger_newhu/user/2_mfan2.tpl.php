...
<div class="ordernav">
        <a href="<?php  echo $this->createMobileUrl('mfan1',array('uid'=>$uid,'dluid'=>$dluid))?>"><span>我的朋友</span></a>
        <a href="<?php  echo $this->createMobileUrl('mfan2',array('level'=>1,'uid'=>$uid,'dluid'=>$dluid))?>" class="cur"><span>朋友的朋友</span></a>
...
<div class="allorder">
    <ul id="lists">
    <?php  if($fans1) { ?>
        <?php  if(is_array($fans2)) { foreach($fans2 as $k => $f) { ?>
