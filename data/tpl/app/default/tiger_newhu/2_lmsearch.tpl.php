...
<!--<div class="top top2 mgz xi30 cen bai">
    超级搜索
    <a href="#"><div class="topl"><img src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/cqlist/images/left.png" align='absmiddle' style='margin-top:-4px;'></div></a>
</div>-->
<div class="con9 mgz">
...
<div class="con10 mgz bgbai">
    ...
    <div class="con10f ov">
        <ul>
        	<?php  if(is_array($keyarr)) { foreach($keyarr as $v) { ?>
            <a href="<?php  echo $this->createMobileUrl('cqlist',array('key'=>$v,'dluid'=>$dluid,'pid'=>$pid,'lx'=>2,'zn'=>$zn))?>"><li><?php  echo $v;?></li></a>
            <?php  } } ?>
        </ul>
    </div>
</div>
...
<div class="con7 mgz">
    <ul>
    	<?php  if(is_array($goodstj)) { foreach($goodstj as $v) { ?>
        <li><a href="<?php  echo $this->createMobileUrl("view",array("itemid"=>$v["itemid"],"lm"=>2,"pid"=>$pid))?>">
            <div class="con7t cen"><img src="<?php  echo $v['itempic'];?>_300x300q60.jpg" align='absmiddle'></div>
            <div class="con7m xi20 hui" style="height: 37px;overflow: hidden;"><?php  echo $v['itemtitle'];?></div>
            <div class="con7f ov">
                <div class="con7fl f xi18">原价￥<span class="xi22"><?php  echo $v['itemprice'];?></span></div>
                <div class="con7fr r xi18 hong">券后价￥<span class="xi20"><?php  echo $v['itemendprice'];?></span></div>
            </div>
            <div class="con7x2 ov">
                <div class="con7x2l f">
                    <div class="con7x2ll f xi18 bai">领券</div>
                    <div class="con7x2lr f xi18">减<?php  echo $v['couponmoney'];?></div>
                </div>
                <div class="con7xr r xi18 hui">销量<?php  echo $v['itemsale'];?></div>
            </div></a>
        </li>
         <?php  } } ?>
