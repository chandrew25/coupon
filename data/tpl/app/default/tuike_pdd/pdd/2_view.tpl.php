...
<head>
    ...
    <link rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/pdd/css/m-cui.css" />
    <link rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/pdd/css/m-lib.css" />
    <link rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/pdd/css/style.css" />
...
//		wx.hideOptionMenu();
		wx.onMenuShareAppMessage({
			...
			imgUrl: "<?php  echo $views['itempic5']['0'];?>"
		}); 
...
<body style="padding-top:0">
    ...
    <div class="main">
        <div class="good-item">
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <a href="" class="pic"><img src="<?php  echo $v;?>" alt=""></a>
                        </div>
                        <?php  } } ?>
            ...
            <div class="good-txt">
                ...
                <div class="price">
                    <span class="team-num">已拼<?php  echo $views['itemsale'];?>人</span>
        ...
        <div class="f-shop">
            <div class="a-box">
                ...
                <a href="<?php  echo $views['url1'];?>" class="a2">领券拼购</a>
            </div>   
            <div class="item-box">
                <a href="<?php  echo $this->createMobileUrl('pddindex')?>" class="item on">
                    <em class="em1"></em>
                    <h5>首页</h5>
                </a>
    ...
    <div class="poster-pop" style="display: none;" >
        <div class="cont"  id="full_img">
            ...
            <!-- 内容区-end -->
            <span class="close" id="fullimg_close"  id="mask" ></span>
...
<script src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/pdd/js/lib.js"></script>
<link rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/pdd/css/swiper.css">
<script src="<?php  echo $_W['siteroot'];?>addons/tiger_newhu/template/mobile/tbgoods/pdd/js/swiper.js"></script>
...
//	     	console.log(1111333);
//  }
    //getviewimg("<?php  echo $views['itemid'];?>");
    //商品海报
		...
		$("#open_fullimg_btn").click(function(){//商品二维码	
			...
			$.ajax({
	            ...
	            success: function (data) {
	             ...
	             console.log("<?php  echo $views['url1'];?>")
		...
		function canvasApp(code_img_src) {	
            ...
            bj_img.onload = function(){
                ...
                item_img.src = "<?php  echo $views['itempic5']['0'];?>";
