...
<body class="body-idx body-com">
    ...
    <div class="main">
        <div class="m-ht17">
            <a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>$category_id,'sort_type'=>0,'with_coupon'=>'true'))?>" class="s <?php  if($sort_type==0) { ?>on<?php  } ?> s1">综合</a>
            <a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>$category_id,'sort_type'=>3,'with_coupon'=>'true'))?>" class="s s2 js-hc <?php  if($sort_type==3) { ?>on<?php  } ?>">券后价<!-- <i></i --></a>
            <a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>$category_id,'sort_type'=>6,'with_coupon'=>'true'))?>" class="s s3 js-hc  <?php  if($sort_type==6) { ?>on<?php  } ?>">销量<!-- <i></i> --></a>
            <a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>$category_id,'sort_type'=>14,'with_coupon'=>'true'))?>" class="s s4 <?php  if($sort_type==14) { ?>on<?php  } ?>">奖励</a>
        </div>
							...
							layui.use('flow', function(){
					            ...
					            flow.load({
					                ...
					                ,done: function(page, next){
										...
										limit++;
			                            var content='';
					                    $.get("<?php  echo $this->createMobileUrl('pddgoodslist',array('op'=>1,'key'=>$keyword,'category_id'=>$category_id,'sort_type'=>$sort_type,'with_coupon'=>$with_coupon,'hd'=>$hd))?>&page="+page, function(res){
					                    	res=JSON.parse(res);
					                    	//alert(res);
					                    	//console.log(res);
