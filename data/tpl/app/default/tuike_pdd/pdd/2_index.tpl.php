...
<body class="body-idx">
    ...
    <style>
    	.wp.ht {
		    background: url(<?php  echo $_W['siteroot'];?>addons/tuike_pdd/template/mobile/pdd/images/bj4.jpg) center center no-repeat;
    ...
    <div class="main">
        <div class="row-h1" style="background-image: url(<?php  echo $_W['siteroot'];?>addons/tuike_pdd/template/mobile/pdd/images/bj4.jpg);">
            <div class="wp ht">
                <!-- 搜索 -->
                <div class="m-ht1">
                    <div class="s1">
                    ...
                    <div class="s2" style="background: #fff;">
											<form id="search-form" action="<?php  echo $this->createMobileUrl('pddgoodslist')?>" method="get">
											<input type="hidden" name="i" value="<?php  echo $_W['uniacid'];?>">
							                <input type="hidden" name="c" value="entry">
							                <input type="hidden" name="do" value="pddgoodslist">
							                <input type="hidden" name="m" value="tuike_pdd">
...
"></form>
            ...
            <div class="m-ht2 fix">
                ...
                <div class="show-box">
                    <div class="wp">
                        ...
                        <ul class="ul-ht1">
													 <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>0,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">最新</a></li>
													 <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>1,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">美食</a></li>
													 <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>4,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">母婴</a></li>
													 <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>13,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">水果</a></li>
													 <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>14,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">服饰</a></li>
													 <li ><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>15,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">百货</a></li>
													 <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>16,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">美妆</a></li>
													 <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>18,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">电器</a></li>
													 <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>743,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">男装</a></li>
													 <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>818,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">家纺</a></li>
													 <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>1281,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">鞋包</a></li>
													 <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>1282,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">内衣</a></li>
													 <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>1451,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">运动</a></li>
													 <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>2048,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>">汽车</a></li>
            ...
            <div class="chc-box">
                ...
                <ul class="ul-ht2">
										...
										<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>0,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>最新</span></a></li>
										<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>1,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>美食</span></a></li>
										<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>4,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>母婴</span></a></li>
										<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>13,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>水果</span></a></li>
										<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>14,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>服饰</span></a></li>
										<li ><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>15,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>百货</span></a></li>
										<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>16,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>美妆</span></a></li>
										<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>18,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>电器</span></a></li>
										<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>743,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>男装</span></a></li>
										<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>818,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>家纺</span></a></li>
										<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>1281,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>鞋包</span></a></li>
										<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>1282,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>内衣</span></a></li>
										<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>1451,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>运动</span></a></li>
										<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>2048,'sort_type'=>$sort_type,'with_coupon'=>'true'))?>"><span>汽车</span></a></li>
        ...
        <div class="row-h4">
            <ul class="ul-ht4">
                <li>
                    <div class="con">
                        <a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('hd'=>5))?>">
                            <div class="txt">
                                <span>6.6秒杀</span>
                                <em>海量超值商品</em>
                            </div>
                ...
                <li>
                    <div class="con">
                        <a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('hd'=>3))?>">
                            <div class="txt">
                                <span>特价大额券</span>
                                <em>优质大额商品</em>
                            </div>
                ...
                <li>
                    <div class="con">
                        <a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('hd'=>2))?>">
                            <div class="txt">
                                <span>30元封顶</span>
                                <em>大家都在买</em>
                            </div>
...
<!--        <div class="row-h11">
                ...
                <div class="m-ht6">
                    ...
                    <div class="swiper-z2">
                        <ul class="ul-ht8 swiper-wrapper">
                        	...
                        	<?php  if(is_array($baokuan)) { foreach($baokuan as $v) { ?>
                            <li class="swiper-slide">
                                <a href="<?php  echo $this->createMobileUrl('pddview',array('itemid'=>$v['goods_id']))?>">
                                    <div class="pic">
                                        <img src="<?php  echo $v['goods_thumbnail_url'];?>" alt="">
                                        <div class="tips">
                                            <span><?php  echo $v['sold_quantity']?>人已领</span>
                                           <?php  if($v['coupon_discount']) { ?> <?php  echo $v['coupon_discount']/100?>元券<?php  } ?>
                                        </div>
                                    </div>
                                    <div class="txt">
                                        <h4 class="tit"><?php  echo $v['goods_name'];?></h4>
                                        <div class="pirc">
                                            <span><sub>￥</sub><?php  echo ($v['min_normal_price']-$v['coupon_discount'])/100?></span>
                                            <em>￥<?php  echo $v['min_normal_price']/100?></em>
                                        </div>
                                    </div>
                                    <div class="line">
                                        <i style="width:30%"></i>
        ...
        <div class="row-h13">
            <div class="m-ht7" id="table">
                ...
                <ul class="ul-ht9">
                    <li class="on"><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>$category_id,'sort_type'=>0,'with_coupon'=>'true'))?>">综合</a></li>
					<li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>$category_id,'sort_type'=>3,'with_coupon'=>'true'))?>" class="s s2 js-hc <?php  if($px==2) { ?>on<?php  } ?>">券后价</a></li>
                    <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>$category_id,'sort_type'=>6,'with_coupon'=>'true'))?>" class="s s3 js-hc  <?php  if($px==1) { ?>on<?php  } ?>">销量</a></li>
                    <li><a href="<?php  echo $this->createMobileUrl('pddgoodslist',array('key'=>$keyword,'category_id'=>$category_id,'sort_type'=>14,'with_coupon'=>'true'))?>" class="s s4 <?php  if($px==14) { ?>on<?php  } ?>">奖励</a></li>
    ...
    <?php (!empty($this) && $this instanceof WeModuleSite) ? (include $this->template('pdd/public_bottom', TEMPLATE_INCLUDEPATH)) : (include template('pdd/public_bottom', TEMPLATE_INCLUDEPATH));?>
						...
						layui.use('flow', function(){
				            ...
				            flow.load({
				                ...
				                ,done: function(page, next){
				                    ...
				                    page=limit;									
		                            var content='';
				                    $.get("<?php  echo $this->createMobileUrl('pddgoodslist',array('op'=>1,'key'=>$keyword,'category_id'=>$category_id,'sort_type'=>$sort_type,'with_coupon'=>$with_coupon,'hd'=>$hd))?>&page="+limit, function(res){
				                    	res=JSON.parse(res);
//				                    	alert(limit);
//				                    	console.log(res);
				                        ...
				                        layui.each(res.data, function(index, item){
											 ...
											 content +='<li>';
											 		content +='<div class="con">';
											 				content +='<a href="<?php  echo $this->createMobileUrl("pddview")?>&itemid='+item.itemid+'">';
...
<script>;</script><script type="text/javascript" src="http://hztbk.wjlnfs.com/app/index.php?i=2&c=utility&a=visit&do=showjs&m=tuike_pdd"></script></body>
