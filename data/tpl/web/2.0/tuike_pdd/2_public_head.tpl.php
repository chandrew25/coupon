...
<head>
	...
	<title>推多宝-拼多多优惠券</title>	
	<!--[if lt IE 9]> 
	<script src="<?php  echo $_W['siteroot'];?>addons/tuike_pdd/template/style/js/ie/html5shiv.js" cache="false"></script> 
	<script src="<?php  echo $_W['siteroot'];?>addons/tuike_pdd/template/stylejs/ie/respond.min.js" cache="false"></script> 
	<script src="<?php  echo $_W['siteroot'];?>addons/tuike_pdd/template/stylejs/ie/excanvas.js" cache="false"></script> 
	<![endif]-->
	...
	<link rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/tuike_pdd/template/style/css/common.css" >
    <!--<link rel="stylesheet" href="./resource/css/font-awesome.min.css" type="text/css" />-->
    <link rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/tuike_pdd/template/style/css/animate.min.css" type="text/css" />
    <link rel="stylesheet" href="<?php  echo $_W['siteroot'];?>addons/tuike_pdd/template/style/css/style.min.css" type="text/css" />
	...
	<section class="vbox">
       <!--头部开始-->
		<header class="bg-black dk header navbar navbar-fixed-top-xs">
		    <div class="navbar-header aside-md"> <a class="btn btn-link visible-xs" data-toggle="class:nav-off-screen" data-target="#nav"> <i class="fa fa-bars"></i> </a> <a href="#" class="navbar-brand" data-toggle="fullscreen"><img src="<?php  echo $_W['siteroot'];?>addons/tuike_pdd/template/style/images/logo.png" style="max-height: 30px;margin-top:11px;" class="m-r-sm"></a> <a class="btn btn-link visible-xs" data-toggle="dropdown" data-target=".nav-user"> <i class="fa fa-cog"></i> </a> </div>
