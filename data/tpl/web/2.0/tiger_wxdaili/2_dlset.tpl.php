...
<div class="panel panel-default">
  ...
  <!--<div class="form-group">
		...
		<div class="form-group">
				<label class="col-xs-12 col-sm-3 col-md-2 control-label">团长功能开启</label>
				<div class="col-xs-12 col-sm-9">
					<label class="checkbox-inline">
							<input type="radio" name="tztype" id="tztype" value="0" <?php  if($set['tztype'] ==0) { ?>checked<?php  } ?>>不开启
					</label>
					<label class="checkbox-inline">
							<input type="radio" name="tztype" id="tztype" value="1" <?php  if($set['tztype'] == 1) { ?>checked<?php  } ?>>开启
					</label>
						<span class="help-block" >开启，在代理中心会有团长管理按钮</span>
				</div>
		</div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-9">
           <label class="checkbox-inline">
              <input type="radio" name="dlfxtype" id="dlfxtype" value="0" <?php  if($set['dlfxtype'] ==0) { ?>checked<?php  } ?>>开启
           </label>
           <label class="checkbox-inline">
              <input type="radio" name="dlfxtype" id="dlfxtype" value="1" <?php  if($set['dlfxtype'] == 1) { ?>checked<?php  } ?>>不开启
           </label>
            <span class="help-block" >不开启，代理在会员中心，提交不了订单返现</span>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr>
                    <td>
                        <div class="input-group">
                          ...
                          <input type="text" name="dlbl1" value="<?php  echo $set['dlbl1'];?>" class="form-control" placeholder="填写数字">
                          <span class="input-group-addon">%</span>
                        </div>
                    </td>
                    <td>
                        <div class="input-group">
                          ...
                          <input type="text" name="dlbl2" value="<?php  echo $set['dlbl2'];?>" class="form-control" placeholder="填写数字">
                          <span class="input-group-addon">%</span>
                        </div>
                    </td>
                    <td style="border-right:0">
                        <div class="input-group">
                          ...
                          <input type="text" name="dlbl3" value="<?php  echo $set['dlbl3'];?>" class="form-control" placeholder="填写数字">
                          <span class="input-group-addon">%</span>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="input-group">
                          ...
                          <input type="text" name="dlbl1t2" value="<?php  echo $set['dlbl1t2'];?>" class="form-control" placeholder="填写数字">
                          <span class="input-group-addon">%</span>
                        </div>
                    </td>
                    <td>
                        <div class="input-group">
                          ...
                          <input type="text" name="dlbl2t3" value="<?php  echo $set['dlbl2t3'];?>" class="form-control" placeholder="填写数字">
                          <span class="input-group-addon">%</span>
                        </div>
                    </td>
                </tr>
                <tr>
                    <td>
                        <div class="input-group">
                          <div class="input-group-addon">提取三级佣金比率</div>
                          <input type="text" name="dlbl1t3" value="<?php  echo $set['dlbl1t3'];?>" class="form-control" placeholder="填写数字">
                          <span class="input-group-addon">%</span>
                        </div>
                    </td>
                </tr>
   ...
   <div class="panel panel-default">
       ...
       <div class="panel-body">
            ...
            <div class="form-group">
             ...
             <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">支付成功提醒</label>
                <div class="col-sm-9 col-xs-12" style="margin-top: 6px;">
                    <div class="input-group">
                       <input type="text" name="zfmsg0" value="<?php  echo $set['zfmsg0'];?>" class="form-control" placeholder=""><span class="help-block" >如：#昵称#您已经成功支付#金额#元！</span>
                    </div>

                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">一级收到提醒</label>
                <div class="col-sm-9 col-xs-12" style="margin-top: 6px;">
                    <div class="input-group">
                       <input type="text" name="zfmsg1" value="<?php  echo $set['zfmsg1'];?>" class="form-control" placeholder=""><span class="help-block" >如：您的朋友#昵称#成功申请代理，您获得了#金额#元奖励！</span>
                    </div>

                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">二级收到提醒</label>
                <div class="col-sm-9 col-xs-12" style="margin-top: 6px;">
                    <div class="input-group">
                       <input type="text" name="zfmsg2" value="<?php  echo $set['zfmsg2'];?>" class="form-control" placeholder=""><span class="help-block" >如：您朋友的朋友#昵称#成功申请代理，您获得了#金额#元奖励！</span>
                    </div>

                </div>
            </div>
            <div class="form-group">
                <label class="col-xs-12 col-sm-3 col-md-2 control-label">三级收到提醒</label>
                <div class="col-sm-9 col-xs-12" style="margin-top: 6px;">
                    <div class="input-group">
                       <input type="text" name="zfmsg3" value="<?php  echo $set['zfmsg3'];?>" class="form-control" placeholder=""><span class="help-block" >如：您朋友的朋友的朋友#昵称#成功申请代理，您获得了#金额#元奖励！</span>
                    </div>
