            ...
            <div class='panel-body'>
               <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-9">
                         ...
                         <input type="text" class="form-control" placeholder="" name="kword" value="<?php  echo $item['kword'];?>">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-1 control-label">海报时间</label>
                    <div class="col-xs-12 col-sm-9">
                        <label class="radio-inline"><input type="radio" name="rtype" value="1" 
	         			<?php  if($item['rtype']==1) { ?> checked="checked" <?php  } ?>>临时30天</label>
                        <label class="radio-inline"><input type="radio" name="rtype" value="0"
                        <?php  if($item['rtype']==0) { ?> checked="checked"<?php  } ?>>永久</label>
                        <span class="help-block" style="color:#ff0000">这里选择好后，不要修改，如果一定要修改，清空海报缓存，重新生成海报</span>
                    </div>
...
<!--div class="panel panel-default setting">
	...
	<div class="panel-body">
	        ...
	        <div class="form-group">
	            ...
	            <div class="col-sm-9 col-xs-12">
	               	<input type="text" class="form-control" name="sharedesc" value="<?php  if($item) { ?><?php  echo $item['sharetitle'];?><?php  } else { ?>免费领取积分，兑大奖！<?php  } ?>">
	            </div>
	        </div>	
            <div class="form-group">
