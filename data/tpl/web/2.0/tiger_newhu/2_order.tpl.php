...
<form action="<?php  echo $this->createWebUrl('order',array('op'=>'pljs'))?>" method="post" class="form-horizontal" id="form1">
        ...
        <table class="table table-hover">
            ...
            <tbody id="table_content" >
                ...
                <tr  >
                    ...
                    <?php  if($l['jl']) { ?>
                    <Br><a style="margin-top:4px;margin-bottom:4px;" href="<?php  echo $this->createWebUrl('shorder', array('id' => $l['id'], 'op' => 'yf','type'=>$l['type'],'page'=>$page))?>" onclick="return confirm('订单确认，奖励发到粉丝余额！');return false;" title="奖励发到粉丝余额" class="btn btn-sm btn-primary">审核【奖励余额】</a>
                   <?php  } else { ?>
                   <Br><a style="margin-top:4px;margin-bottom:4px;" href="<?php  echo $this->createWebUrl('oldshorder', array('id' => $l['id'], 'op' => 'yf','type'=>$l['type'],'page'=>$page))?>" onclick="return confirm('订单确认，奖励发到粉丝余额！');return false;" title="奖励发到粉丝余额" class="btn btn-sm btn-info">旧版审核【奖励余额】</a>
                   <?php  } ?>
                    <Br><a style="margin-top:4px;margin-bottom:4px;" href="<?php  echo $this->createWebUrl('shorder', array('id' => $l['id'], 'op' => 'delete','page'=>$page))?>" onclick="return confirm('确定要删除订单！');return false;" title="确定要删除订单！" class="btn btn-sm btn-danger">删除订单</a>

                     <Br><a href="<?php  echo $this->createWebUrl('shorder', array('id' => $l['id'], 'op' => 'up','type'=>$l['type'],'page'=>$page))?>" title="更新订单" class="btn btn-sm btn-warning">更新订单</a>
