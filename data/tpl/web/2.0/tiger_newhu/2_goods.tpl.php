...
<div class="panel panel-default">
   ...
   <div class="panel-body">
        <form action="" method="post" class="form-horizontal form" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label for="inputEmail3" class="col-sm-2 control-label">订单数</label>
            <div class="col-sm-10">
              <input type="text" class="form-control" name="ordrsum" value="<?php  echo $item['ordrsum'];?>"  placeholder="">
              <span class="help-block">这里填了用户提交满多少个订单才能兑换，防止刷积分兑换,不填则不限制</span>
            </div>
          </div>
					
					<div class="form-group">
						<label for="inputEmail3" class="col-sm-2 control-label">不够订单提示</label>
						<div class="col-sm-10">
							<input type="text" class="form-control" name="ordermsg" value="<?php  echo $item['ordermsg'];?>"  placeholder="">
							<span class="help-block">上面不满足条件的提示信息 如：该商品需要购买至少5单,才能兑换！</span>
						</div>
					</div>
