      ...
      <table class="table">
       ...
       <?php  if(is_array($data)) { foreach($data as $item) { ?>
        <tr>
          ...
          <td><?php  echo $item['nickname'];?>（uid:<?php  echo $item['uid'];?>）<br>OPENID:<?php  echo $item['openid'];?><Br>支付宝：<span style="color:#ff0000"><?php  echo $item['zfbuid'];?></span> (姓名：<span style="color:#ff0000"><?php  echo $item['tname'];?></span>)</td>
...
<style>
	.panel .table td, .panel .table th{overflow: initial;}
</style>
