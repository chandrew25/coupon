			        ...
			        <section class="scrollable padder">
                        <ul class="breadcrumb no-border no-radius b-b b-light pull-in">
                          ...
                          <li class="active">海报管理</li>
												...
												<a href="<?php  echo $this->createWebUrl('apphb', array('op' => 'post'));?>" class="btn btn-s-md btn-info tigerbtn"><i class="fa fa-plus"></i> 添加海报背景</a>
												<a href="<?php  echo $this->createWebUrl('apphb', array('op' => 'display'));?>" class="btn btn-s-md btn-success tigerbtn"><i class="fa fa-pencil-square-o "></i> 管理海报背景</a>
                           ...
                           <div class="panel-body">
                               	...
                               	<div class="form-group">
                               		...
                               		<div class="col-sm-10">
                               			...
                               			<span class="help-block" style="color:#ff0000">750*1334   .jpg格式 100K内</span>
                               		</div>
                               	</div> 
                               	<div class="form-group">
                                    ...
                                    <?php  if(is_array($list)) { foreach($list as $item) { ?>
                                      <tr>
                                        ...
                                        <td style="text-align:right;">
                                          <a href="<?php  echo $this->createWebUrl('apphb', array('id' => $item['id'], 'op' => 'post'))?>" title="编辑" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i>编辑</a>
                                          <a href="<?php  echo $this->createWebUrl('apphb', array('id' => $item['id'], 'op' => 'delete'))?>" onclick="return confirm('此操作不可恢复，确认删除？');return false;" title="删除" class="btn btn-sm btn-default"><i class="fa fa-remove"></i>删除</a>
                                        </td>
                                      </tr>
                                      <?php  } } ?>
                                     </table>
