			    ...
			    <section class="vbox">
			        <section class="scrollable padder"  style="padding-bottom:50px;">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li <?php  if($type==0) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('memberecord',array('id'=>$uid,'type'=>0))?>">积分记录</a></li>
                            <li <?php  if($type==1) { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('memberecord',array('id'=>$uid,'type'=>1))?>">余额记录</a></li>
