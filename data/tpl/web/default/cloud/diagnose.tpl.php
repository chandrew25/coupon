...
<div class="form-horizontal" id="js-cloud-diagnose" ng-controller="CloudDiagnoseCtrl" ng-cloak>
	...
	<div class="form-group">
		...
		<div class="col-sm-10">
			...
			<div class="help-block">请查看您的站点ID和通信密钥, 需要保证与<a href="<?php  echo url('cloud/profile');?>">云服务平台记录</a>的值一致, 否则不能正常使用云平台的各项服务.<br /><font color="red">重置后需要重新购买授权码，否则无法使用。</font></div>
		</div>
	</div>
	<div class="form-group">
