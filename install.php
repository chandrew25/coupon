		...
		<div class="container">
			<div class="header" style="margin:15px auto;">
				<ul class="nav nav-pills pull-right" role="tablist">
					...
					<li role="presentation"><a href="http://www.m213.cn">官网</a></li>
					<li role="presentation"><a href="http://www.m213.cn">访问论坛</a></li>
				</ul>
				<img src="?res=logo" />
			</div>
			...
			<div class="panel-body">
				<div class="form-group">
					...
					<div class="col-sm-10">
						...
						<label class="radio-inline">
							<a target="_blank" href="//www.m213.cn"><img border="0" src="//pub.idqqimg.com/wpa/images/group.png" alt="技术支持" title="技术支持"></a>
						</label>
